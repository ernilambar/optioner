  ...
  class App {
    ...
    initTab() {
      ...
      this.wrapper.find('.nav-tab-wrapper a').on('click', e => {
        ...
        $(e.target).addClass('nav-tab-active'); // Get target.

        const targetGroup = $(e.target).attr('href'); // Save active tab in local storage.
